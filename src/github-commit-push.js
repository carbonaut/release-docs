...
const commitAndPush = async () => {
  ...
  try {
    let referenceCommitInfo = await getCommitReference();
    let treeInfo = await createTree(referenceCommitInfo);
    let commitInfo = await createCommit(referenceCommitInfo, treeInfo);
    await updateCommitReference(commitInfo);
